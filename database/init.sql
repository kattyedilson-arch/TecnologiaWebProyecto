...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  telefono VARCHAR(20),
  foto_perfil VARCHAR(255) NULL,             -- Ruta web de la foto de perfil (assets/uploads/perfiles/...)
...
-- ---------------------------------------------------------
-- Turnos fijos definidos por el administrador
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Disponibilidad horaria de cada tutor (por turno fijo)
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Ofertas de materias creadas por el administrador
-- Cada oferta = materia + nivel académico + turno (1 cupo por tutor)
-- ---------------------------------------------------------
CREATE TABLE IF NOT EXISTS ofertas_admin (
...
-- ---------------------------------------------------------
-- Respuestas de tutores a las ofertas (aceptar/rechazar)
-- ---------------------------------------------------------
CREATE TABLE IF NOT EXISTS oferta_respuesta (
...
-- Disponibilidad horaria del tutor (con materia que impartirá en el turno)
INSERT INTO disponibilidad_tutor (id_disponibilidad, id_tutor, id_materia, id_turno) VALUES
(1, 1, 1, 3),
(2, 1, 3, 3),
(3, 1, 3, 2)
AS nuevo
ON DUPLICATE KEY UPDATE id_turno = nuevo.id_turno;
...
-- 4. Tutores (usuarios 4-13 / id_tutor 2-11)
INSERT INTO usuarios (id_usuario, id_rol, nombre, apellido, correo, usuario, contrasena_hash, telefono, estado) VALUES
...
-- Materias asignadas a los tutores
INSERT INTO tutor_materia (id_tutor, id_materia) VALUES
(2, 1), (2, 4),
(3, 2), (3, 5),
(4, 3), (4, 8),
...
-- Disponibilidad horaria de los tutores (cada registro indica la materia y turno asignado)
INSERT INTO disponibilidad_tutor (id_disponibilidad, id_tutor, id_materia, id_turno) VALUES
(4, 2, 1, 3),
(5, 2, 4, 3),
(6, 3, 2, 2),
...
-- 5. Estudiantes (usuarios 14-63 / id_estudiante 2-51)
INSERT INTO usuarios (id_usuario, id_rol, nombre, apellido, correo, usuario, contrasena_hash, telefono, estado) VALUES
...
(57, 3, 'Paola', 'Durán', 'paola.duran@tutorias.local', 'estudiante45', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '70000057', 'activo'),
...
(63, 3, 'Graciela', 'Núñez', 'graciela.nunez@tutorias.local', 'estudiante51', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '70000063', 'activo')
AS nuevo
ON DUPLICATE KEY UPDATE usuario = nuevo.usuario;
