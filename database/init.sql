...
-- Fuerza el charset UTF-8 en el cliente mysql que importa este script.
-- Sin esto, el entrypoint de Docker importa con latin1 y los acentos/ñ
-- quedan doblemente codificados (ej: "IngenierÃ­a" en vez de "Ingeniería").
SET NAMES utf8mb4;
