...
<head>
  ...
  <style>
    ...
    * { font-family: 'Inter', system-ui, -apple-system, sans-serif; }
    ...
    .sidebar-nav a.active { background: linear-gradient(90deg, #223B87, #2f4ba7); color: #fff; box-shadow: 0 6px 16px rgba(34, 59, 135,.4); border-left: 3px solid var(--cn-celeste); }
    ...
    .avatar-md {
      ...
      background: linear-gradient(135deg, #223B87, #48A4E0); color: #fff;
    ...
    .hero-band {
      background: linear-gradient(120deg, #16255c 0%, #2f4ba7 55%, #48A4E0 130%);
    ...
    .avatar-lg { width: 84px; height: 84px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 900; font-size: 1.8rem; background: linear-gradient(135deg, #223B87, #48A4E0); color: #fff; box-shadow: 0 8px 20px rgba(34, 59, 135,.35); }
