...
<div class="row justify-content-center">
  <div class="col-lg-8 col-xl-7">
    <div class="d-flex align-items-center justify-content-between mb-3">
      ...
      <a href="<?= base_url() . ($_SESSION['rol'] === 'administrador' ? '/controllers/dashboard.php' : ($_SESSION['rol'] === 'tutor' ? '/views/tutor/panel.php' : '/views/estudiante/panel.php')) ?>" class="btn btn-outline-secondary btn-sm d-flex align-items-center gap-1">
      ...
      <div class="col-md-4">
        <div class="card card-custom p-4 text-center h-100">
          <div class="avatar-lg mx-auto mb-3">
            <span><?= iniciales($usuario['nombre'], $usuario['apellido']) ?></span>
          </div>
