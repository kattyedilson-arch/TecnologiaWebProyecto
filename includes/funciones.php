...
// respaldo, un <span> con iniciales. $clase puede ser "avatar-md",
// "avatar-lg", etc. $extra permite estilos inline (p. ej. degradado).
function avatarHTML($foto, $inicialesTexto, $clase = 'avatar-md', $extra = '')
{
    ...
    return '<span class="' . $clase . '"' . $estilo . '>' . htmlspecialchars($inicialesTexto) . '</span>';
}
